<?php
include 'C:\xampp\htdocs\ak\controller\commandeC.php';
   ...
   <?php include "header.php" ?>
		...
		<div class="page-container">
			...
			<div class="row">
				<div class="col-6">
<br> <br>
				<a class="btn btn-success" href="C:\xampp\htdocs\shop\Views\Front\ajouterCommande.php" style="position: relative; top : 35px; right:40px;">Ajouter une commande</a>
		
		<center><h1>Liste des commandes</h1></center>
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for commande..">
		...
		<table id="myTable" class="table table-striped"  >
            ...
            <td> <?php echo $commande['commandeDate']; ?></td>
				...
				<td>
					<a class="btn btn-danger" href="supprimerCommande.php?id_commande=<?php echo $commande['id_commande'];
                       ?>">Supprimer</a>
        ...
        <a href="imprimerListeCommande.php">print</a>
