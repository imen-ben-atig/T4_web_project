...
<tr>
        ...
        <td><input type="date" name="commandeDate" id="commandeDate" ></td>
    </tr>
    <tr>
        <td>
        ...
        <td><input type="number" name="commandePrix" id="commandePrix" ></td>
    ...
    <tr>
        ...
        <td>
        <input type="text" name="commandeNom" id="commandeNom" >
