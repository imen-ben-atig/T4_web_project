    ...
    <?php include "header.php" ?>
		...
		<div class="page-container">
         ...
         <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
                                <div class="table-responsive table--no-card m-b-80" style="width:132%">
...
<td class="text-center"><?PHP echo $produit['date_ajout']; ?></td>

<td width="100" height="100"><?PHP echo '<img src="images/'.$produit['img'].'"height="200px" width="200px" >'; ?></td>
<td class="text-center"><?PHP echo $produit['Nomjeux']; ?></td>
