...
<input type="hidden" id="IdCategorie" name="IdCategorie" value="<?php echo $categorie["IdCategorie"];?> " 
        ...
        <td><input type="text" name="NomCategorie" id="NomCategorie"  value="<?php echo $categorie["NomCategorie"];?>"></td>
    </tr>
   
    
    <input type="hidden" id="NomOffre" name="NomOffre" value="<?php echo $categorie["NomOffre"];?> " 
                    minlength="3" maxlength="20" size="10" >
                    <br><br>
